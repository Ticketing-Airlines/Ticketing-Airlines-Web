...
<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
    ...
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-br from-black via-gray-900 to-purple-900 text-white py-32 overflow-hidden">
      ...
      <div class="relative container mx-auto px-4 text-center z-10 pt-12">
        <div class="inline-flex items-center rounded-full px-4 py-2 mb-6" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px);">
          <Luggage class="w-4 h-4 mr-2 text-white" />
          <span class="font-semibold text-sm text-white">Baggage Information</span>
        </div>
    ...
    <div class="container mx-auto px-4 -mt-24 relative z-20 mb-16">
      <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white shadow-2xl overflow-hidden">
          <!-- Header -->
          <div class="bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 px-8 py-6 relative overflow-hidden">
            ...
            <div class="relative flex items-center gap-4">
              <div class="w-14 h-14 bg-white rounded-lg flex items-center justify-center">
                <Calculator class="h-8 w-8 text-gray-900" />
              </div>
              <div>
                <h2 class="text-2xl font-black text-white tracking-tight uppercase">Baggage Calculator</h2>
          ...
          <div class="p-8">
            ...
            <div class="mb-8">
              ...
              <div class="grid grid-cols-2 gap-4">
                <button
                  ...
                  :class="[
                    'h-20 font-black uppercase tracking-wide border-4 transition-all relative overflow-hidden group',
                    flightType === 'domestic' 
                ...
                <button
                  ...
                  :class="[
                    'h-20 font-black uppercase tracking-wide border-4 transition-all relative overflow-hidden',
            ...
            <div class="mb-8">
              ...
              <div class="bg-gray-50 p-6 border-l-4" :class="flightType === 'domestic' ? 'border-blue-600' : 'border-purple-600'">
                <div class="flex items-center justify-between mb-4">
                  <div>
                    <div class="text-5xl font-black text-gray-900">{{ baggageWeight }}kg</div>
                    <div class="text-sm text-gray-600 font-semibold mt-1">Selected Weight</div>
                  </div>
                  <div class="text-right">
                    <div class="text-3xl font-black" :class="flightType === 'domestic' ? 'text-blue-600' : 'text-purple-600'">
                      ₱{{ selectedWeightTier.price.toLocaleString() }}
                    </div>
                    <div class="text-sm text-gray-600 font-semibold">per bag</div>
                  </div>
                </div>
                <input
            ...
            <div class="mb-8">
              ...
              <div class="flex items-center justify-center gap-6">
                <Button
                  ...
                  class="w-16 h-16 bg-gray-900 hover:bg-gray-700 disabled:opacity-30"
                >
                  <Minus class="w-6 h-6" />
                </Button>
                <div class="text-center">
                  <div class="text-6xl font-black text-gray-900">{{ baggageCount }}</div>
                  <div class="text-sm text-gray-600 font-semibold uppercase tracking-wider">Bag(s)</div>
                </div>
                <Button
                  @click="incrementBags"
            ...
            <!-- Total Price Display -->
            <div class="bg-gradient-to-br from-gray-900 to-blue-900 p-8 mb-6 relative overflow-hidden">
              ...
              <div class="relative flex items-center justify-between">
                ...
                <div class="text-right">
                  <div class="text-5xl font-black text-white">₱{{ totalPrice.toLocaleString() }}</div>
                </div>
              </div>
            </div>
            ...
            <Button 
              ...
              class="w-full h-20 text-xl font-black text-white transition-all duration-300 uppercase tracking-widest relative overflow-hidden group"
    ...
    <section class="py-20 bg-white relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="flex items-center gap-6 mb-16">
          <div class="w-2 h-24 bg-gradient-to-b from-purple-600 to-gray-900"></div>
          <div>
            <h2 class="text-5xl font-black text-black mb-2 tracking-tight uppercase">Standard Allowance</h2>
            <p class="text-lg text-gray-600 font-semibold">What's included with your ticket</p>
          </div>
        </div>

        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <!-- Cabin Baggage -->
          <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-8 border-l-8 border-blue-600 relative group hover:shadow-2xl transition-shadow">
            <!-- Corner Badge -->
            <div class="absolute -top-4 -right-4 w-20 h-20 bg-blue-600 flex items-center justify-center transform rotate-12 group-hover:rotate-0 transition-transform">
              <Briefcase class="w-10 h-10 text-white" />
            </div>

            <h3 class="text-3xl font-black text-gray-900 mb-6 uppercase tracking-tight">Cabin Baggage</h3>
            
            <div class="space-y-6">
              <!-- Main Item -->
              <div class="bg-white p-6 border-t-4 border-blue-600">
                <div class="flex items-center gap-4 mb-4">
                  <div class="w-12 h-12 bg-blue-600 flex items-center justify-center">
                    <Briefcase class="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h4 class="text-xl font-black text-gray-900 uppercase">Main Item</h4>
              ...
              <!-- Personal Item -->
              <div class="bg-white p-6 border-t-4 border-blue-400">
                <div class="flex items-center gap-4 mb-4">
                  <div class="w-12 h-12 bg-blue-400 flex items-center justify-center">
                    <ShoppingBag class="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h4 class="text-xl font-black text-gray-900 uppercase">Personal Item</h4>
          ...
          <!-- Checked Baggage -->
          <div class="bg-gradient-to-br from-purple-50 to-purple-100 p-8 border-l-8 border-purple-600 relative group hover:shadow-2xl transition-shadow">
            <!-- Corner Badge -->
            <div class="absolute -top-4 -right-4 w-20 h-20 bg-purple-600 flex items-center justify-center transform rotate-12 group-hover:rotate-0 transition-transform">
              <Luggage class="w-10 h-10 text-white" />
            </div>

            <h3 class="text-3xl font-black text-gray-900 mb-6 uppercase tracking-tight">Checked Baggage</h3>
            
            <div class="space-y-6">
              <!-- Domestic -->
              <div class="bg-white p-6 border-t-4 border-purple-600">
                <div class="flex items-center gap-4 mb-4">
                  <div class="w-12 h-12 bg-purple-600 flex items-center justify-center">
                    <Plane class="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h4 class="text-xl font-black text-gray-900 uppercase">Domestic Flights</h4>
              ...
              <!-- International -->
              <div class="bg-white p-6 border-t-4 border-purple-400">
                <div class="flex items-center gap-4 mb-4">
                  <div class="w-12 h-12 bg-purple-400 flex items-center justify-center">
                    <Plane class="w-6 h-6 text-white transform rotate-45" />
                  </div>
                  <div>
                    <h4 class="text-xl font-black text-gray-900 uppercase">International</h4>
    ...
    <section class="py-20 bg-gray-50 relative overflow-hidden">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-16 text-center">
          ...
          <h2 class="text-5xl font-black text-gray-900 mb-4 uppercase tracking-tighter">Special Items</h2>
          <p class="text-xl text-gray-600 font-semibold">Items with special handling requirements</p>
        </div>

        <!-- Special Items Grid -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <!-- Sports Equipment -->
          <div class="bg-white p-6 shadow-xl relative group cursor-pointer transform hover:-translate-y-2 transition-all overflow-hidden">
            ...
            <div class="relative z-10">
              <div class="w-16 h-16 bg-blue-100 flex items-center justify-center mb-4 group-hover:bg-blue-600 transition-colors">
                <Package class="w-8 h-8 text-blue-600 group-hover:text-white transition-colors" />
              </div>
              
              <h3 class="text-xl font-black text-gray-900 mb-2 uppercase">Sports Equipment</h3>
              ...
              <div class="pt-4 border-t-2 border-gray-200 group-hover:border-blue-600 transition-colors">
                <div class="flex items-center justify-between">
                  ...
                  <span class="text-xl font-black text-green-600">₱1,000</span>
                </div>
              </div>
            </div>
          ...
          <div class="bg-white p-6 shadow-xl relative group cursor-pointer transform hover:-translate-y-2 transition-all overflow-hidden">
            ...
            <div class="relative z-10">
              <div class="w-16 h-16 bg-purple-100 flex items-center justify-center mb-4 group-hover:bg-purple-600 transition-colors">
                <Music class="w-8 h-8 text-purple-600 group-hover:text-white transition-colors" />
              </div>
              
              <h3 class="text-xl font-black text-gray-900 mb-2 uppercase">Musical Instruments</h3>
              ...
              <div class="pt-4 border-t-2 border-gray-200 group-hover:border-purple-600 transition-colors">
                <div class="flex items-center justify-between">
                  <span class="text-xs font-bold text-gray-500 uppercase tracking-widest">From</span>
                  <span class="text-xl font-black text-green-600">₱800</span>
                </div>
              </div>
            </div>
          ...
          <div class="bg-white p-6 shadow-xl relative group cursor-pointer transform hover:-translate-y-2 transition-all overflow-hidden">
            ...
            <div class="relative z-10">
              <div class="w-16 h-16 bg-pink-100 flex items-center justify-center mb-4 group-hover:bg-pink-600 transition-colors">
                <Baby class="w-8 h-8 text-pink-600 group-hover:text-white transition-colors" />
              </div>
              
              <h3 class="text-xl font-black text-gray-900 mb-2 uppercase">Baby Equipment</h3>
          ...
          <div class="bg-white p-6 shadow-xl relative group cursor-pointer transform hover:-translate-y-2 transition-all overflow-hidden">
            ...
            <div class="relative z-10">
              <div class="w-16 h-16 bg-orange-100 flex items-center justify-center mb-4 group-hover:bg-orange-600 transition-colors">
                <Camera class="w-8 h-8 text-orange-600 group-hover:text-white transition-colors" />
              </div>
              
              <h3 class="text-xl font-black text-gray-900 mb-2 uppercase">Photography Gear</h3>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="mb-20 pt-8">
          <div class="flex items-start gap-6 mb-6">
            <div class="relative">
              <div class="w-32 h-32 bg-white flex items-center justify-center relative z-10">
                <XCircle class="w-16 h-16 text-red-600" />
              </div>
              <div class="absolute top-3 left-3 w-32 h-32 bg-black"></div>
            </div>
            <div class="flex-1">
              <div class="inline-block bg-black px-6 py-2 mb-4">
                <span class="text-white font-black text-sm uppercase tracking-widest">Safety First</span>
              </div>
              <h2 class="text-6xl font-black text-white mb-3 tracking-tighter uppercase leading-none">
                DON'T<br/>PACK<br/>THESE
              </h2>
            </div>
          </div>
          <div class="bg-white/10 backdrop-blur-md border-4 border-white p-6 max-w-2xl">
            <p class="text-white font-black text-lg uppercase tracking-wide">Serious consequences await those who ignore these rules</p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4 bg-gray-900 p-8 relative group cursor-pointer transform hover:scale-105 transition-transform">
            <!-- Danger Stripe -->
            ...
            <div class="mt-8">
              <div class="text-9xl font-black text-red-600 mb-4 leading-none">01</div>
              <div class="h-1 w-20 bg-red-600 mb-4"></div>
              <h3 class="text-3xl font-black text-white mb-3 uppercase tracking-tight">Explosives</h3>
              <p class="text-gray-400 font-bold uppercase text-sm tracking-wider">Fireworks • Flares • Ammunition</p>
            </div>
            
            <!-- Warning Icon -->
            <div class="absolute bottom-4 right-4 w-16 h-16 border-4 border-red-600 flex items-center justify-center">
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4 bg-gray-900 p-8 relative group cursor-pointer transform hover:scale-105 transition-transform">
            ...
            <div class="mt-8">
              <div class="text-9xl font-black text-red-600 mb-4 leading-none">02</div>
              <div class="h-1 w-20 bg-red-600 mb-4"></div>
              <h3 class="text-3xl font-black text-white mb-3 uppercase tracking-tight">Weapons</h3>
              <p class="text-gray-400 font-bold uppercase text-sm tracking-wider">Guns • Knives • Martial Arts Items</p>
            </div>
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4 bg-gray-900 p-8 relative group cursor-pointer transform hover:scale-105 transition-transform">
            ...
            <div class="mt-8">
              <div class="text-9xl font-black text-red-600 mb-4 leading-none">03</div>
              <div class="h-1 w-20 bg-red-600 mb-4"></div>
              <h3 class="text-3xl font-black text-white mb-3 uppercase tracking-tight">Flammables</h3>
              <p class="text-gray-400 font-bold uppercase text-sm tracking-wider">Gas • Paint • Lighter Fluid</p>
            </div>
          ...
          <!-- Compact Items Row 1 -->
          <div class="col-span-6 md:col-span-3 bg-white border-8 border-gray-900 p-6">
            <div class="text-5xl font-black text-gray-900 mb-2">04</div>
            <h4 class="text-lg font-black text-gray-900 uppercase mb-1">Compressed Gases</h4>
            <p class="text-xs text-gray-600 font-bold uppercase">CO2 • Diving Tanks</p>
          </div>

          <div class="col-span-6 md:col-span-3 bg-white border-8 border-gray-900 p-6">
            <div class="text-5xl font-black text-gray-900 mb-2">05</div>
            <h4 class="text-lg font-black text-gray-900 uppercase mb-1">Toxins</h4>
            <p class="text-xs text-gray-600 font-bold uppercase">Poison • Chemicals</p>
          </div>

          <div class="col-span-6 md:col-span-3 bg-white border-8 border-gray-900 p-6">
            <div class="text-5xl font-black text-gray-900 mb-2">06</div>
            <h4 class="text-lg font-black text-gray-900 uppercase mb-1">Sharp Objects</h4>
            <p class="text-xs text-gray-600 font-bold uppercase">Scissors • Box Cutters</p>
          </div>

          <div class="col-span-6 md:col-span-3 bg-white border-8 border-gray-900 p-6">
            <div class="text-5xl font-black text-gray-900 mb-2">07</div>
            <h4 class="text-lg font-black text-gray-900 uppercase mb-1">Power Banks</h4>
        ...
        <div class="mt-12 relative">
          <div class="bg-yellow-400 p-8 relative overflow-hidden">
            ...
            <div class="relative flex items-start gap-6">
              <div class="flex-shrink-0">
                <div class="w-20 h-20 bg-gray-900 flex items-center justify-center border-4 border-red-600">
                  <AlertCircle class="w-10 h-10 text-red-600" />
                </div>
              </div>
              <div class="flex-1">
                <h3 class="text-3xl font-black text-gray-900 mb-3 uppercase tracking-tight">Caught? Here's What Happens:</h3>
                <div class="grid md:grid-cols-3 gap-4">
                  <div class="bg-gray-900 p-4">
                    <div class="text-red-600 font-black text-lg mb-1">CONFISCATION</div>
                    <p class="text-white text-sm font-semibold">Item seized immediately</p>
                  </div>
                  <div class="bg-gray-900 p-4">
                    <div class="text-red-600 font-black text-lg mb-1">FINES</div>
                    <p class="text-white text-sm font-semibold">Up to ₱100,000 penalty</p>
                  </div>
                  <div class="bg-gray-900 p-4">
                    <div class="text-red-600 font-black text-lg mb-1">LEGAL ACTION</div>
                    <p class="text-white text-sm font-semibold">Criminal prosecution possible</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- Side Accent -->
          <div class="absolute -right-4 top-1/2 transform -translate-y-1/2 w-8 h-32 bg-red-600"></div>
        </div>
      </div>
    </section>

    <!-- Tips Section - Brutalist Cards -->
    <section class="py-20 bg-gradient-to-br from-gray-900 via-blue-900 to-black text-white overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-16">
          ...
          <h2 class="text-5xl font-black text-white mb-4 uppercase tracking-tighter">Travel Smart</h2>
          <p class="text-xl text-white/80 font-semibold">Expert tips for hassle-free packing</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <!-- Tip 1 -->
          <div class="bg-white/10 backdrop-blur-md border-2 border-white/20 p-8 relative">
            ...
            <div class="mt-4">
              <h3 class="text-2xl font-black text-white mb-4 uppercase tracking-tight">Weigh Before You Go</h3>
          ...
          <!-- Tip 2 -->
          <div class="bg-white/10 backdrop-blur-md border-2 border-white/20 p-8 relative">
            <div class="absolute -top-5 -left-5 w-14 h-14 bg-purple-600 border-4 border-white flex items-center justify-center">
              <span class="text-2xl font-black text-white">2</span>
            </div>
            
            <div class="mt-4">
              <h3 class="text-2xl font-black text-white mb-4 uppercase tracking-tight">Label Everything</h3>
          ...
          <!-- Tip 3 -->
          <div class="bg-white/10 backdrop-blur-md border-2 border-white/20 p-8 relative">
            <div class="absolute -top-5 -left-5 w-14 h-14 bg-green-600 border-4 border-white flex items-center justify-center">
              <span class="text-2xl font-black text-white">3</span>
            </div>
            
            <div class="mt-4">
              <h3 class="text-2xl font-black text-white mb-4 uppercase tracking-tight">Pack Smart</h3>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="mb-20">
          <div class="flex items-end gap-8 mb-8">
            <div>
              <div class="text-sm font-black text-blue-600 uppercase tracking-widest mb-2">Knowledge Base</div>
              <h2 class="text-7xl md:text-9xl font-black text-gray-900 uppercase tracking-tighter leading-none">
                FAQ
              </h2>
            </div>
            <div class="flex gap-3 mb-8">
              <div class="w-8 h-8 bg-blue-600"></div>
              <div class="w-8 h-8 bg-purple-600"></div>
              <div class="w-8 h-8 bg-gray-900"></div>
            </div>
          </div>
          <div class="h-2 w-full bg-gradient-to-r from-blue-600 via-purple-600 to-transparent"></div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12 lg:col-span-7 bg-gray-900 relative group">
            <!-- Number Badge -->
            <div class="absolute -top-8 -left-8 w-24 h-24 bg-blue-600 border-8 border-gray-50 flex items-center justify-center z-10">
              <span class="text-5xl font-black text-white">1</span>
            </div>
            
            <div class="p-10 pt-16">
              <div class="mb-6">
                <div class="inline-block bg-blue-600 px-4 py-1 mb-4">
              ...
              <div class="bg-white/10 backdrop-blur-sm p-6 border-l-4 border-blue-600">
                <p class="text-white font-bold leading-relaxed">
                  ...
                  Airport baggage counters charge premium prices. Book online now through our website or manage 
                  booking portal to lock in the lowest rates. Why pay extra when you can save?
                </p>
              </div>

              <!-- Highlight Box -->
              <div class="mt-6 flex items-center gap-4 bg-blue-600 p-4">
                <div class="text-4xl font-black text-white">50%</div>
                <div>
                  <div class="text-white font-black uppercase text-sm">Savings Online</div>
          ...
          <div class="col-span-12 lg:col-span-5 bg-white border-8 border-purple-600 relative group">
            <div class="absolute -top-8 -right-8 w-24 h-24 bg-purple-600 border-8 border-gray-50 flex items-center justify-center z-10">
              <span class="text-5xl font-black text-white">2</span>
            </div>
            
            <div class="p-8 pt-16">
              <div class="mb-4">
                <div class="inline-block bg-purple-600 px-4 py-1 mb-3">
              ...
              <p class="text-gray-700 font-bold leading-relaxed mb-6">
                Pay per kilogram overage. Rates depend on your route. Pro tip: Weigh bags at home or redistribute items between bags at check-in.
              </p>

              <div class="bg-purple-100 p-4 border-l-4 border-purple-600">
                <div class="flex items-center gap-2 text-purple-900">
                  <Weight class="w-5 h-5" />
                  <span class="font-black text-sm uppercase">Smart Packing = Savings</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-span-12 lg:col-span-5 bg-white border-8 border-green-600 relative group">
            <div class="absolute -top-8 -left-8 w-24 h-24 bg-green-600 border-8 border-gray-50 flex items-center justify-center z-10">
              <span class="text-5xl font-black text-white">3</span>
            </div>
            
            <div class="p-8 pt-16">
              <div class="mb-4">
                <div class="inline-block bg-green-600 px-4 py-1 mb-3">
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="bg-green-100 p-3 border-2 border-green-600">
                  <div class="text-green-600 font-black text-xs uppercase mb-1">Allowed</div>
                  <div class="text-2xl font-black text-gray-900">100ml</div>
                </div>
                <div class="bg-green-100 p-3 border-2 border-green-600">
                  <div class="text-green-600 font-black text-xs uppercase mb-1">Bag Size</div>
                  <div class="text-2xl font-black text-gray-900">1 Liter</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-span-12 lg:col-span-7 bg-gradient-to-br from-orange-500 to-red-600 relative group">
            <div class="absolute -top-8 -right-8 w-24 h-24 bg-gray-900 border-8 border-gray-50 flex items-center justify-center z-10">
              <span class="text-5xl font-black text-white">4</span>
            </div>
            
            <div class="p-10 pt-16">
              <div class="mb-6">
                <div class="inline-block bg-gray-900 px-4 py-1 mb-4">
              ...
              <div class="bg-white/10 backdrop-blur-sm p-6 border-l-4 border-white">
                <p class="text-white font-bold leading-relaxed mb-4">
                  <span class="font-black text-2xl">NOPE.</span> Baggage is personal and non-transferable. 
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-white/30">
                  ...
                  <span class="text-white font-black uppercase text-sm">No Pooling • No Sharing • No Exceptions</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="mt-12 bg-gray-900 p-12 relative overflow-hidden">
          <!-- Corner Accent -->
          <div class="absolute bottom-0 right-0 w-64 h-64 border-8 border-white/10"></div>
          
          <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div class="flex-1">
              <div class="text-blue-400 font-black text-sm uppercase tracking-widest mb-3">Still Confused?</div>
              <h3 class="text-4xl font-black text-white mb-4 uppercase tracking-tight">We're Here to Help</h3>
            ...
            <div class="flex gap-4">
              <Button class="h-16 px-8 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-wider">
                Live Chat
              </Button>
              <Button class="h-16 px-8 bg-transparent border-4 border-white text-white hover:bg-white hover:text-gray-900 font-black uppercase tracking-wider transition-all">
                Call Us
              </Button>
            </div>
          </div>
      ...
      <div class="relative container mx-auto px-4 z-10">
        <div class="max-w-4xl mx-auto text-center">
          <div class="inline-flex items-center justify-center w-24 h-24 bg-white/10 backdrop-blur-sm rounded-2xl mb-8">
            <Luggage class="w-12 h-12 text-white" />
          </div>
          
          <h2 class="text-5xl font-black text-white mb-6 uppercase tracking-tight">Ready to Travel?</h2>
          ...
          <div class="flex flex-col sm:flex-row gap-6 justify-center">
            <Button class="h-16 px-10 bg-white text-gray-900 hover:bg-gray-100 font-black text-lg uppercase tracking-wider shadow-2xl">
              <ShoppingBag class="w-6 h-6 mr-3" />
              Add Baggage Now
            </Button>
            <Button class="h-16 px-10 bg-transparent border-4 border-white text-white hover:bg-white/10 font-black text-lg uppercase tracking-wider transition-all">
