  ...
  <div v-show="!isLoading" class="min-h-screen bg-white">
    ...
    <section class="relative overflow-hidden h-screen">
          ...
          <CarouselItem class="h-full">
            <div class="relative w-full h-full">
              ...
              <div class="absolute inset-0 flex flex-col items-center justify-start text-center px-4 pt-24">
                ...
                <!-- Main Title -->
                <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black mb-4 leading-tight text-white uppercase tracking-tight">
                  Paradise<br/>
                  <span class="text-transparent bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text">Awaits</span>
                </h1>
                
                <!-- Subtitle -->
                <p class="text-sm sm:text-base lg:text-lg max-w-2xl mx-auto mb-6 font-bold text-white/90 leading-relaxed">
                  Experience the pristine white beaches and crystal clear waters of Boracay Island.
                </p>
                
                <!-- CTA Button -->
                <Button class="h-10 px-6 bg-white text-gray-900 hover:bg-gray-100 font-black text-sm uppercase tracking-wider shadow-lg transform hover:-translate-y-1 transition-all duration-300">
      ...
      <div class="absolute bottom-0 left-0 right-0 z-10 pointer-events-auto">
        <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
          <!-- Flight Search Form -->
          <Card class="bg-white shadow-2xl border-4 border-gray-900 overflow-hidden">
            <CardContent class="p-6 sm:p-8">
              ...
              <div :class="`grid gap-4 mb-8 ${searchParams.tripType === 'round-trip' ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-4' : 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3'}`">
                ...
                <!-- Departure Date -->
                <div>
                  <label class="block text-sm font-black text-gray-900 mb-3 uppercase tracking-widest">Departure</label>
                  <Popover>
              ...
              <Button
                @click="searchFlights"
                class="w-full h-16 bg-blue-600 hover:bg-blue-700 text-white rounded-none font-black text-lg uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-3 transform hover:-translate-y-1"
              >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-20">
          <div class="flex items-center justify-center gap-4 mb-6">
            ...
            <div class="w-3 h-3 bg-purple-600"></div>
            <div class="w-3 h-3 bg-orange-600"></div>
          </div>
          <h2 class="text-6xl md:text-7xl font-black text-gray-900 mb-6 uppercase tracking-tighter">Why Choose Us?</h2>
          <div class="flex items-center justify-center gap-3 mb-4">
            <div class="h-1 w-16 bg-gray-900"></div>
            <p class="text-xl text-gray-600 font-bold uppercase tracking-wider">Experience Excellence</p>
            <div class="h-1 w-16 bg-gray-900"></div>
          </div>
        </div>
    ...
    <section class="py-20 bg-gradient-to-br from-gray-900 via-blue-900 to-black text-white overflow-hidden relative">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-20">
          ...
          <h2 class="text-6xl md:text-7xl font-black text-white mb-6 leading-tight uppercase tracking-tighter">
    ...
    <section class="py-20 bg-white relative overflow-hidden">
      <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-gray-600 mb-12 max-w-2xl mx-auto font-bold leading-relaxed">
